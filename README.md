...
This project applies a multi-factor asset pricing framework to evaluate the performance of selected US equity ETFs. Using the Fama–French factor model, ETF returns are decomposed into systematic risk exposures (market, size, value, momentum) and residual alpha.
